...
export declare abstract class TemplatedItemsComponent implements DoCheck, OnDestroy, AfterContentInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<TemplatedItemsComponent, "ng-component", never, { "items": "items"; "selectedIndex": "selectedIndex"; }, { "setupItemView": "setupItemView"; }, ["itemTemplateQuery"], never, false>;
}
