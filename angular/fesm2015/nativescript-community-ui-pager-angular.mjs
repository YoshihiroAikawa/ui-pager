...
import { registerElement, extractSingleViewRecursive, isInvisibleNode } from '@nativescript/angular';
...
PagerComponent.ɵcmp = i0.ɵɵdefineComponent({ type: PagerComponent, selectors: [["Pager"]], features: [i0.ɵɵProvidersFeature([
        ...
        ]), i0.ɵɵInheritDefinitionFeature], decls: 3, vars: 0, consts: [["loader", ""]], template: function PagerComponent_Template(rf, ctx) {
        if (rf & 1) {
